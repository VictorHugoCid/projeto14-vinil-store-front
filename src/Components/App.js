...
export default function App() {
    ...
    return (
        <>
            <GlobalStyle />
            <globalContext.Provider value = {{ token, setValue, reRender, setReRender, isShown, setIsShown, isShownSignIn, setIsShownSignIn, isShownCart, setIsShownCart, style, setStyle}}>
                <BrowserRouter>
                    <Routes>
